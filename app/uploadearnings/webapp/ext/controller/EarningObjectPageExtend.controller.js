sap.ui.define(['sap/ui/core/mvc/ControllerExtension', "sap/ui/model/json/JSONModel",], function (ControllerExtension, JSONModel) {
	...
	return ControllerExtension.extend('com.scb.uploadearningsv2.ext.controller.EarningObjectPageExtend', {
		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
		override: {
			/**
			 * Called when a controller is instantiated and its View controls (if available) are already created.
			 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
			 * @memberOf com.scb.uploadearningsv2.ext.controller.EarningObjectPageExtend
			 */
