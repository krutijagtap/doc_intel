sap.ui.define(
  ["sap/ui/core/mvc/Controller", "sap/m/MessageToast", "sap/ui/core/Component"],
  function (Controller, MessageToast, Component) {
    ...
    return Controller.extend("peeranalysis.controller.ReportsView", {
      ...
      onAfterRendering: function () {
        ...
        // 1. build URL first
        const sUrl = this._isFLP()
          ? this._getFLPUrl()
          : this._getStandaloneUrl();
      ...
      _getFLPUrl: function () {
        ...
        const completeurl =
          formattedUrl +
          "#Earnings-upload?sap-ui-app-id-hint=saas_approuter_com.scb.uploadearnings";
        return completeurl;
      },
    });
  }
